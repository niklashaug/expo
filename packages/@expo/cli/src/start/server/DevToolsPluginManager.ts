import type { ModuleDescriptorDevTools } from 'expo-modules-autolinking';
...
export default class DevToolsPluginManager {
  ...
  private async queryAutolinkedPluginsAsync(projectRoot: string): Promise<AutolinkingPlugin[]> {
    ...
    const autolinkingModule = require(resolvedPath) as typeof import('expo-modules-autolinking');
